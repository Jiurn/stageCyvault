...
@guest
<li class="nav-item d-none d-sm-inline-block"><a class="lispan" href="{{route('login')}}"><span class="glyphicon glyphicon-log-in"></span></a></li>

@else
<li class="nav-item d-none d-sm-inline-block"><a class="lispan" href="{{ route('logout')}}"><span class="glyphicon glyphicon-log-out"></span>Logout</a></li>
...
<img src="<?php echo url('images'); ?>/Logo-PM-SCADA-Final-whitered4.png" alt="PM SCADA Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
...
<span class="info-box-number">@foreach($test as $key => $data)
{{$data->likes}}
@endforeach</span>
</div>
...
<script src="<?php echo url('adminlte'); ?>/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js"></script>

<script src="<?php echo url('adminlte'); ?>/dist/js/adminlte.js?v=3.2.0"></script>


<script src="<?php echo url('adminlte'); ?>/plugins/jquery-mousewheel/jquery.mousewheel.js"></script>
<script src="<?php echo url('adminlte'); ?>/plugins/raphael/raphael.min.js"></script>
<script src="<?php echo url('adminlte'); ?>/plugins/jquery-mapael/jquery.mapael.min.js"></script>
<script src="<?php echo url('adminlte'); ?>/plugins/jquery-mapael/maps/usa_states.min.js"></script>

<script src="<?php echo url('adminlte'); ?>/plugins/chart.js/Chart.min.js"></script>

<script src="<?php echo url('adminlte'); ?>/dist/js/demo.js"></script>

<script src="<?php echo url('adminlte'); ?>/dist/js/pages/dashboard2.js"></script>
</body>
</html>
